...
export const getServerSideProps = async () => {
  ...
  const [
    ...
    get<SharepointResponse<IServices[]>>(ENDPOINTS.servicesServicesPage, { headers }),
    get<SharepointResponse<IServicesMainSettings[]>>(ENDPOINTS.servicesServicesPageMainSettings, { headers }),
